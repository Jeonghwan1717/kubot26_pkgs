...
#include "kubot25w_pkgs/msg/kubot_control_msgs.hpp"
...
namespace gazebo {
    ...
    class kubot25_plugin : public ModelPlugin
    {
        ...
        rclcpp::Subscription<kubot25w_pkgs::msg::KubotControlMsgs>::SharedPtr Kubot_control_mode_sub;
    ...
    public :
        ...
        void Kubot_control_callback(const kubot25w_pkgs::msg::KubotControlMsgs::SharedPtr msg);
        void Kubot_joy_callback(const sensor_msgs::msg::Joy::SharedPtr joy_msgs);
    };
    GZ_REGISTER_MODEL_PLUGIN(kubot25_plugin)
}

void gazebo::kubot25_plugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
    // 가제보 표준 출력 대신 강제 콘솔 출력으로 진입 여부 파악
    std::cout << "========================================" << std::endl;
    std::cout << "   KUBOT25 MODEL PLUGIN STARTING...     " << std::endl;
    std::cout << "========================================" << std::endl;
    ...
    this->KubotModesp = this->node_->create_subscription<std_msgs::msg::Int32>(
        "/KubotMode", 10, std::bind(&kubot25_plugin::KubotMode, this, std::placeholders::_1));
    this->Kubot_control_mode_sub = this->node_->create_subscription<kubot25w_pkgs::msg::KubotControlMsgs>(
        "/Kubot_Control_Msg", 10, std::bind(&kubot25_plugin::Kubot_control_callback, this, std::placeholders::_1));
    this->Kubot_joy_sub = this->node_->create_subscription<sensor_msgs::msg::Joy>( 
        "/joy", 10, std::bind(&kubot25_plugin::Kubot_joy_callback, this, std::placeholders::_1));
    ...
    this->update_connection = gazebo::event::Events::ConnectWorldUpdateBegin(
        boost::bind(&kubot25_plugin::UpdateAlgorithm, this, ::_1));

    std::cout << "========================================" << std::endl;
    std::cout << "   KUBOT25 MODEL PLUGIN LOADED SUCCESS! " << std::endl;
    std::cout << "   JOINT STATE PUBLISHER ONLINE!        " << std::endl;
    std::cout << "========================================" << std::endl;
} // Load 함수 끝

void gazebo::kubot25_plugin::UpdateAlgorithm(const common::UpdateInfo & _info)
{
    ...
    js.name = {
        ...
        "L_Shoulder_pitch_joint", "L_Arm_roll_joint", "L_Hand_pitch_joint",
        "R_Shoulder_pitch_joint", "R_Arm_roll_joint", "R_Hand_pitch_joint",
...
void gazebo::kubot25_plugin::setjoints() 
{
    ...
    L_Arm_roll_joint = this->model->GetJoint("L_Arm_roll_joint");
    ...
    R_Arm_roll_joint = this->model->GetJoint("R_Arm_roll_joint");
...
void gazebo::kubot25_plugin::getjointdata()
{
...
void gazebo::kubot25_plugin::jointcontroller()
{
    for (int j = 0; j < nDoF; j++) {
...
void gazebo::kubot25_plugin::initializejoint()
{
...
void gazebo::kubot25_plugin::setjointPIDgain()
{
...
void gazebo::kubot25_plugin::KubotMode(const std_msgs::msg::Int32::SharedPtr msg)
{
...
void gazebo::kubot25_plugin::Kubot_control_callback(const kubot25w_pkgs::msg::KubotControlMsgs::SharedPtr msg)
{
...
// 3. 조이스틱 신호 수신 함수
void gazebo::kubot25_plugin::Kubot_joy_callback(const sensor_msgs::msg::Joy::SharedPtr msg)
{
    // 조이스틱 연동 로직
